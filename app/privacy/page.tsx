...
export const metadata: Metadata = {
  title: "개인정보처리방침 | Cyclone Atlas",
  description: "Cyclone Atlas 개인정보처리방침 및 광고 쿠키 안내",
  robots: { index: true, follow: true },
};

export default function PrivacyPage() {
  return <main className="privacy-page">
    <a className="privacy-back" href="/">← 태풍 경로 지도</a>
    <h1>개인정보처리방침</h1>
    <p>시행일: 2026년 8월 7일</p>
    <section><h2>수집하는 정보</h2><p>Cyclone Atlas는 회원가입이나 직접적인 개인정보 입력을 요구하지 않습니다. 서비스 운영 과정에서 브라우저와 광고 제공업체가 쿠키 등 온라인 식별자를 사용할 수 있습니다.</p></section>
